/************************************************************
  ...
  Author:               Created Time: 2017/6/8 15:16:50
...
/************************************************************
SQL代码：
select Jin_e,Qi_shu,Price,Goods_Name,Category_Name,Goods_img,Is_index,Is_hot,Img_index,Zulin_index,Uuid from V_index
delete from V_index
INSERT INTO V_index (Jin_e,Qi_shu,Price,Goods_Name,Category_Name,Goods_img,Is_index,Is_hot,Img_index,Zulin_index,Uuid)
     VALUES
           ('','','','','','','','','','','')
UPDATE V_index SET ...
变量赋值代码：
...
namespace AgileFrame.Orm.PersistenceLayer.Model
{
    ...
    public class V_index : ITableImplement
    {
        ...
        public override void LoadAllAttributes(bool IsLoadAllAttributes)
        {
            ...
            this.jin_e_initialized = IsLoadAllAttributes;this.qi_shu_initialized = IsLoadAllAttributes;this.price_initialized = IsLoadAllAttributes;this.goods_name_initialized = IsLoadAllAttributes;this.category_name_initialized = IsLoadAllAttributes;this.goods_img_initialized = IsLoadAllAttributes;this.is_index_initialized = IsLoadAllAttributes;this.is_hot_initialized = IsLoadAllAttributes;this.img_index_initialized = IsLoadAllAttributes;this.zulin_index_initialized = IsLoadAllAttributes;this.uuid_initialized = IsLoadAllAttributes;
        }
        /// <summary></summary>
        ...
        public V_index(double jin_e1, int qi_shu1, double price1, string goods_name1, string category_name1, string goods_img1, bool is_index1, int is_hot1, bool img_index1, bool zulin_index1, Guid uuid1)
        {
